			...
			<div className='w-full md:w-1/2 mt-10 md:mt-0'>
				...
				<form onSubmit={submit} className='flex mt-20 xs:mt-10'>
					<input
						...
						className='bg-white focus:outline-none border-0 px-4 md:px-6 py-3 w-44 md:w-1/2'
						value={state}
					...
					<button className='bg-blue-500 hover:bg-blue-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-4 md:px-6 py-3 whitespace-no-wrap'>
						...
						<span className='animate-ping absolute h-3 w-3 rounded-full bg-white opacity-75 -mt-4 ml-32'></span>
						Choose Class!
					</button>
				</form>
			</div>
